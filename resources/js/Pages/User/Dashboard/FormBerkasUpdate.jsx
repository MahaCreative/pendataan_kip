...
export default function FormBerkasUpdate({
    modelBerkas,
    editBerkas,
    setEditBerkas,
    setModelBerkas,
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        router.post(route("update_berkas"), {
            _method: "patch",
            id: modelBerkas.id,
            ktp: data.ktp,
            kk: data.kk,
    ...
    useEffect(() => {
        ...
        const matches = Array.from(
            modelBerkas.keterangan.matchAll(regex),
            (match) => match[1]
        );
        setKeterangan(matches);
        console.log(matches);
        setData({
            ...data,
    ...
    return (
        <form onSubmit={submitHandler} className="">
            ...
            <div className="p-2 rounded-lg bg-slate-200  my-2 text-slate-950">
                <p>
                    Berkas anda telah ditolak oleh admin silahkan upload ulang
                    berkas yang ditolak
                </p>
                <p>{modelBerkas.keterangan}</p>
            </div>
            <div className="flex flex-col gap-3">
                {keterangan && keterangan.find((item) => item == "ktp") && (
                ...
                {keterangan && keterangan.find((item) => item == "kk") && (
                    <div className="flex gap-3 items-center">
                        <InputLabel className="w-[15vw] text-white text-xl">
                            KK
                        </InputLabel>
                ...
                {keterangan && keterangan.find((item) => item == "kip") && (
                    <div className="flex gap-3 items-center">
                        <InputLabel className="w-[15vw] text-white text-xl">
                            KIP
                        </InputLabel>
                ...
                {keterangan && keterangan.find((item) => item == "krs") && (
                    <div className="flex gap-3 items-center">
                        <InputLabel className="w-[15vw] text-white text-xl">
                            KRS
                        </InputLabel>
                ...
                {keterangan && keterangan.find((item) => item == "pddikti") && (
                    <div className="flex gap-3 items-center">
                        <InputLabel className="w-[15vw] text-white text-xl">
                            PDDIKI
                        </InputLabel>
